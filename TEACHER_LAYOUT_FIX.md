# 🛠️ Solusi Error: Layout Teacher Not Found

Halo! Error `InvalidArgumentException: Unable to locate a class or view for component [layouts.teacher]` terjadi karena file layout khusus guru belum ada di project Anda.

Silakan buat file baru dengan detail berikut:

**Lokasi File:** `resources/views/layouts/teacher.blade.php`

**Isi Kode (Copy-Paste Semua):**
...
Setelah file ini dibuat, refresh halaman dashboard guru. Error tersebut akan hilang. 🚀
