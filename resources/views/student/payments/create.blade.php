                    ...
                    <div class="mt-8 pt-8 border-t border-gray-200">
                        <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border border-green-100">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    <h4 class="font-bold text-gray-900 mb-2">Konfirmasi via WhatsApp</h4>
                                    <p class="text-sm text-gray-600 mb-4">
                                        Setelah upload bukti pembayaran, klik tombol di bawah untuk mengirim konfirmasi ke Admin melalui WhatsApp agar proses verifikasi lebih cepat.
                                    </p>
                                    <a href="{{ $waUrl }}" target="_blank" rel="noopener noreferrer"
                                       class="inline-flex items-center gap-2 px-6 py-3 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-xl transition-colors shadow-lg shadow-green-500/20">
