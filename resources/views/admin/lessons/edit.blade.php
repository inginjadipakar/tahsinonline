                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.lessons.update', $lesson) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="url" name="video_url" id="video_url" value="{{ old('video_url', $lesson->video_url) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
